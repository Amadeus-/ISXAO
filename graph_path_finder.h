...
public:
	...
	int find_path(const vector3_t&, const vector3_t&, std::vector<vector3_t>&, PVOID, bool, bool);
	void generate_graph(std::vector<vector3_t>&, float, float, float, float, PVOID, bool);
	void init();
