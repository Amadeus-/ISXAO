...
namespace isxao_detours
{
	...
	public:
		...
		void Playfield_t__AddChildDynel_Trampoline(Dynel*, const VECTOR3&, const QUATERNION&);
		void Playfield_t__AddChildDynel_Detour(Dynel*, const VECTOR3&, const QUATERNION&);
