...
namespace isxao_classes
{
	...
	DWORD perk_holder::get_perk_locks(vector<action_lock*> &v) const
	{
		vector<action_lock_t>* p_perk_lock_vector = get_perk_holder_data().p_perk_locks;
	...
	DWORD perk_holder::get_perk_map(map<identity_t, DWORD> &m) const
	{
