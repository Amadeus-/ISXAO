...
public:
	...
	PVOID N3Msg_GetTeamMemberList(LONG);
	bool N3Msg_HasPerk(DWORD);
	bool N3Msg_IsAttacking() const;
	bool N3Msg_IsBattleStation();
	bool N3Msg_IsCharacterInMech(ao::identity_t);
	bool N3Msg_IsCharacterMorphed(ao::identity_t);
	bool N3Msg_IsDungeon();
	bool N3Msg_IsFormulaReady(const ao::identity_t &);
	bool N3Msg_IsGeneralPerk(DWORD);
	bool N3Msg_IsGroupPerk(DWORD);
	bool N3Msg_IsInRaidTeam();
	bool N3Msg_IsInTeam(const ao::identity_t &);
	bool N3Msg_IsItemDisabled(const ao::identity_t &, const ao::identity_t &);
	bool N3Msg_IsItemMine(const ao::identity_t &);
	bool N3Msg_IsItemNFCrystal(const ao::identity_t &, const ao::identity_t &);
	bool N3Msg_IsItemPossibleToUnWear(const ao::identity_t &);
	bool N3Msg_IsItemPossibleToWear(const ao::identity_t &, DWORD, DWORD, bool, DWORD);
	bool N3Msg_IsMoving();
	bool N3Msg_IsMyPetID(const ao::identity_t &);
	bool N3Msg_IsNanoSelfOnly(const ao::identity_t &);
	bool n3_msg_is_npc(const ao::identity_t &);
	bool N3Msg_IsPerk(DWORD);
	...
	bool N3Msg_NameToID(const std::string &, ao::identity_t &);
